#include "mybookurlschemehandler.h"

MyBookUrlSchemeHandler::MyBookUrlSchemeHandler(QObject *parent)
    : QQuickImageProvider(QQuickImageProvider::Pixmap) {}

QPixmap MyBookUrlSchemeHandler::requestPixmap(const QString &id, QSize *size,
...
MyBookUrlSchemeHandler::~MyBookUrlSchemeHandler() { book = nullptr; }
